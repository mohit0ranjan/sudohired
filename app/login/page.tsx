...
import { Mail, Lock, ArrowRight, Github, Chrome, Cpu } from 'lucide-react';
                    ...
                    <div className="bg-card border border-border rounded-xl shadow-sm p-6 space-y-6">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <button
                                ...
                                type="submit"
                                className="w-full py-2.5 bg-primary text-primary-foreground rounded-lg text-sm font-semibold hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-sm disabled:opacity-50"
                            >
